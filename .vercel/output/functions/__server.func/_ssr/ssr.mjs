...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BVX6c7xn.mjs");
...
var manifest = { "0e517499775c5a0ef420d8b0956a6ece644aecbcc10e65f36639213e2b1eb216": {
	functionName: "enhanceAudit_createServerFn_handler",
	importer: () => import("./server-Bs1bChTt.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D3pbkcWL.mjs").then((n) => n.d).then((n) => n.t),
